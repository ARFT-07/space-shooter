...
void iDraw() {
  ...
  if (strcmp(gameState, "menu") == 0) {
    ...
    // Menu Texts
    if (hovernewgame)
      iShowImage(40, (1000 - 370), "assets/images/newgame_mm_hover.png");
    else
      iShowImage(40, (1000 - 350), "assets/images/newgame_mm.png");

    if (hoverdiff)
      iShowImage(40, (1000 - 470), "assets/images/difficulty_mm_hover.png");
    else
      iShowImage(40, (1000 - 450), "assets/images/difficulty_mm.png");

    if (hoverhighscore)
      iShowImage(40, (1000 - 570), "assets/images/highscore_mm_hover.png");
    else
      iShowImage(40, (1000 - 550), "assets/images/highscore_mm.png");

    if (hovercredits)
      iShowImage(40, (1000 - 670), "assets/images/credits_mm_hover.png");
    else
      iShowImage(40, (1000 - 650), "assets/images/credits_mm.png");

    if (hoverquit)
      iShowImage(40, (1000 - 770), "assets/images/quitgame_mm_hover.png");
    else
      iShowImage(40, (1000 - 750), "assets/images/quitgame_mm.png");
  }
...
void iSpecialKeyboard(unsigned char key) {
  ...
  if (strcmp(gameState, "game") == 0) {
    if (key == GLUT_KEY_LEFT && spaceshipX > 0)
      spaceshipX -= 12;
    if (key == GLUT_KEY_RIGHT && spaceshipX < 530)
      spaceshipX += 12;
    if (key == GLUT_KEY_UP && spaceshipY < 730)
      spaceshipY += 12;
...
int gameover(int ax, int ay, int sx, int sy) {
  return (abs(ax - sx) < 25 && abs(ay - sy) < 25);
}
...
void rollingBackground() {
  ...
  if (strcmp(gameState, "game") == 0) {
    ...
    bg_mm1 -= 3;
    bg_mm2 -= 3;
    if (bg_y1 <= -mainmenumax)
      bg_y1 = bg_y2 + mainmenumax;
    if (bg_y2 <= -mainmenumax)
      bg_y2 = bg_y1 + mainmenumax;
  }
}
